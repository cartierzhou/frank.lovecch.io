$(function () {
  var $gallery = $('span#gallery');
  var $ps_container = $('#ps_container');
  var $ps_overlay = $('#ps_overlay');
  var $ps_close = $('#ps_close');
  /**
   * When we click on an album, we load with AJAX the list of pictures for that album.
   * We randomly rotate them except the last one, which is the one the User sees first. 
   * We also resize and center each image.
   */
  $gallery.bind('click', function () {
    var $elem = $(this);
    var album_name = 'album' + parseInt($elem.index() + 1);
    $ps_container.find('img').remove();
    var data = '["/public/images/franklovecchio/2945791126_c443dd45e8.jpg","/public/images/franklovecchio/2945791360_4bb4a2cf36.jpg","/public/images/franklovecchio/2947293957_5f1589cb66.jpg"]';
