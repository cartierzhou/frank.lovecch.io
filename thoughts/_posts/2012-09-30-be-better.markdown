...
There exists such a white board placed a longer arm's length above a walkway in my home - the one between the kitchen and living room - whose sole purpose is to be writ upon, for better or worse, inspiration or groceries. On New Year's Day _2012_, I tediously erased long-standing prior art and scripted the words `BE BETTER` in all capital letters across it, the taste of fresh ink wetting the back of my mouth as the smell made its way through my nasal passage and down. As I sometimes forget, these kinds of things aren't necessarily relatable **\[on the outside\]** to everyone; my roommate **\[and best friend for years\]** proceeded to jest.
...
<h2>[relationships]</h2>
As it turns out, [Facebook](http://facebook.com) makes it far too easy to manage relationships; I would know, I've been on it since _2005_, and even e-mailed them at the time attempting to get the product rolled out at (UIC)[http://uic.org]. There are so many things inherently wrong with the digital forms of communication available to us, but the most notable could best be described by the word `surface`. The `Like` button holds so much more than it represents.

I can count the number of funerals and death services I've attended on my _two_ hands, and consider this a blessing. There's _one_ very important lesson I never grasped, though, and it relates to something more in occurence at family funerals **\[at least my disfunctial ones\]**; that `the only time we see each other is in death`. But hey, we're friends on Facebook.
...
<h2>[technology]</h2>
I removed the possibility of cable at home, and seconded the decision with the internet. I hadn't payed for a television service since college, but the more-than-basic channels had been pushed to us freely with an internet-only package **\[it's funny how that works\]**. I understand the allure of cable, but find far superior the time which replaces vegetable mode.
